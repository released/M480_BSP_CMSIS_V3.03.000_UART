...
{
	if ((((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)))->INTSTS & ((0x1ul << (8))))?1:0))
	{
		while(!((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)))->FIFOSTS & (0x1ul << (14))))
		{
			uartDev.buf[uartDev.len++] = ((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)))->DAT);
		}
	}
	
	if ((((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)))->INTSTS & ((0x1ul << (4))))?1:0))
	{
		while(!((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)))->FIFOSTS & (0x1ul << (14))))
		{
			uartDev.buf[uartDev.len++] = ((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)))->DAT);
...
void UART0_Process(void)
{
	...
	if (uartDev.end)
	{
		...
		UART_Write(((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)),uartDev.buf,uartDev.len);
