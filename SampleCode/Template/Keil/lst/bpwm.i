...
#line 9 "..\\..\\..\\Library\\StdDriver\\src\\bpwm.c"
...
uint32_t BPWM_ConfigOutputChannel(BPWM_T *bpwm, uint32_t u32ChannelNum, uint32_t u32Frequency, uint32_t u32DutyCycle)
{
    ...
    if(u32DutyCycle)
    {
        ...
        (bpwm)->WGCTL0 &= ~(((0xffful << (16)) | (0xffful << (0))) << (u32ChannelNum * 2U));
        (bpwm)->WGCTL0 |= ((1UL) << ((u32ChannelNum * (2U)) + (uint32_t)(16)));
        (bpwm)->WGCTL1 &= ~(((0xffful << (16)) | (0xffful << (0))) << (u32ChannelNum * 2U));
...
void BPWM_ClearADCTriggerFlag(BPWM_T *bpwm, uint32_t u32ChannelNum, uint32_t u32Condition)
{
    (bpwm)->STATUS = ((0x3ful << (16)) << u32ChannelNum);
}
...
uint32_t BPWM_GetADCTriggerFlag(BPWM_T *bpwm, uint32_t u32ChannelNum)
{
    return (((bpwm)->STATUS & ((0x3ful << (16)) << u32ChannelNum)) ? 1UL : 0UL);
}
...
uint32_t BPWM_GetCaptureIntFlag(BPWM_T *bpwm, uint32_t u32ChannelNum)
{
    return (((((bpwm)->CAPIF & ((0x3ful << (8)) << u32ChannelNum)) ? 1UL : 0UL) << 1) |             (((bpwm)->CAPIF & ((0x3ful << (0)) << u32ChannelNum)) ? 1UL : 0UL));
...
void BPWM_ClearDutyIntFlag(BPWM_T *bpwm, uint32_t u32ChannelNum)
{
    (bpwm)->INTSTS = ((0x3ful << (16)) | (0x3ful << (24))) << u32ChannelNum;
}
...
uint32_t BPWM_GetDutyIntFlag(BPWM_T *bpwm, uint32_t u32ChannelNum)
{
    return ((((bpwm)->INTSTS & (((0x3ful << (24)) | (0x3ful << (16))) << u32ChannelNum))) ? 1UL : 0UL);
}
