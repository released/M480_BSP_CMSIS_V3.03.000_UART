...
#line 9 "..\\..\\..\\Library\\StdDriver\\src\\sdh.c"
...
#line 10 "..\\..\\..\\Library\\StdDriver\\src\\sdh.c"
...
#line 11 "..\\..\\..\\Library\\StdDriver\\src\\sdh.c"
...
#line 12 "..\\..\\..\\Library\\StdDriver\\src\\sdh.c"
...
uint8_t volatile g_u8SDDataReadyFlag = (0UL);
...
void SDH_Set_clock(SDH_T *sdh, uint32_t sd_clock_khz)
{
    ...
    if (sd_clock_khz <= 400ul)
    {
        ...
        _SDH_ReferenceClock = ((12000000UL) / 1000ul);
    }
...
uint32_t SDH_Read(SDH_T *sdh, uint8_t *pu8BufAddr, uint32_t u32StartSec, uint32_t u32SecCount)
{
    ...
    for (i=0ul; i<loop; i++)
    {
        g_u8SDDataReadyFlag = (uint8_t)(0UL);
