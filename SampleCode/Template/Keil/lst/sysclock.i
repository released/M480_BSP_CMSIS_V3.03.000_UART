...
void SYS_Init()
{
    ...
    CLK_EnableXtalRC((0x1ul << (3))|(0x1ul << (2))|(0x1ul << (1))|(0x1ul << (0)));

     
    CLK_WaitClockReady((0x1ul << (3))|(0x1ul << (4))|(0x1ul << (1))|(0x1ul << (0)));

     
    CLK_DisablePLL();

     
    ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->PLLCTL = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->PLLCTL & ~(0x108FFFFFul)) | 0x0008421Eul;
    ...
    CLK_SetModuleClock(((1UL<<30)|(1UL<<28) |(0x7UL<<25) |(8UL<<20) |(0x0UL<<18)|(0x0UL<<10)|(0x0UL<<5)|(2UL<<0)), (0x0UL << (8)), 0x0UL);
