...
#line 9 "..\\..\\..\\Library\\StdDriver\\src\\hsusbd.c"
...
#line 10 "..\\..\\..\\Library\\StdDriver\\src\\hsusbd.c"
...
int HSUSBD_GetDescriptor(void)
{
    ...
    case 0x21ul:
    {
        ...
        HSUSBD_MemCopy(g_hsusbd_buf, &g_hsusbd_sInfo->gu8ConfigDesc[9ul+9ul], u32Len);
    ...
    case 0x22ul:
    {
        ...
        if ((((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->OPER & 0x04ul) == 0x04ul)
        {
            u32Len = (((u32Len)<(g_hsusbd_sInfo->gu32HidReportSize[gUsbCmd . wIndex & 0xfful])) ? (u32Len) : (g_hsusbd_sInfo->gu32HidReportSize[gUsbCmd . wIndex & 0xfful]));
            HSUSBD_PrepareCtrlIn((uint8_t *)g_hsusbd_sInfo->gu8HidReportDesc[gUsbCmd.wIndex & 0xfful], u32Len);
        }
        else
        {
            u32Len = (((u32Len)<(g_hsusbd_sInfo->gu32FSHidReportSize[gUsbCmd . wIndex & 0xfful])) ? (u32Len) : (g_hsusbd_sInfo->gu32FSHidReportSize[gUsbCmd . wIndex & 0xfful]));
    ...
    case 0x03ul:
    {
        ...
        {
            u32Len = (((u32Len)<(g_hsusbd_sInfo->gu8StringDesc[gUsbCmd . wValue & 0xfful][0])) ? (u32Len) : (g_hsusbd_sInfo->gu8StringDesc[gUsbCmd . wValue & 0xfful][0]));
            if ((u32Len % g_hsusbd_CtrlMaxPktSize) == 0ul)
            {
                g_hsusbd_CtrlZero = (uint8_t)1ul;
            }
