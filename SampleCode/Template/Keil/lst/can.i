...
#line 9 "..\\..\\..\\Library\\StdDriver\\src\\can.c"
...
static uint8_t gu8LockCanIf[2ul][2ul] = {0ul};     
...
#line 40 "..\\..\\..\\Library\\StdDriver\\src\\can.c"
...
static uint32_t LockIF(CAN_T *tCAN)
{
    ...
    u32CanNo = (tCAN == ((CAN_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x61000UL))) ? 1ul : 0ul;
